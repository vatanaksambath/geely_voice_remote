...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 max-w-md md:max-w-3xl lg:max-w-5xl mx-auto bg-white dark:bg-[#111] border-t border-gray-200 dark:border-gray-800 flex items-center justify-around z-50 rounded-t-3xl shadow-[0_-10px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_-10px_40px_rgba(0,0,0,0.5)] safe-area-pb">
      {navItems.map((item) => {
